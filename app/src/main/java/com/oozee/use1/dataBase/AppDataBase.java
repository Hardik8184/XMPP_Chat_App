package com.oozee.use1.dataBase;
...
public class AppDataBase {
    ...
    public static final String DATABASE_NAME = "chat_user1.db";
    ...
    public static final String KEY_IS_MSG_READ = "is_msg_read";   //flag value = "1"/"0"
    ...
    public synchronized ArrayList<ChatMessage> getAllMessages() {
...
//                    KEY_SENDER + " = '" + sender_name + "' group by  " + KEY_MESSAGE + " order by " + KEY_DATE_TIME + " ASC";
            String selectMsgesQuery = "select * from " + DATABASE_TABLE_NAME + " group by  " + KEY_MESSAGE + " order by " +
                    KEY_DATE_TIME + " ASC";
